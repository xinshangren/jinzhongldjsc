<template>
  <div>
    <van-tabs @touchmove.prevent  :offset-top="111" ref="tabId1" id="tabId1" v-model="active" :sticky="true" :ellipsis="false" line-width="20%"
    ...
    <div
     id="callButton" style="z-index: 2;display: none; width: 100%; height: 53px; position: fixed;bottom: 56px;
