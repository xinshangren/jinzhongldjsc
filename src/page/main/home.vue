    ...
    <div style="width: 100%;background: #ffffff;margin-top: 5px;padding-bottom: 20px;">
      ...
      >
        ...
        <div class="ui-col ui-col" style="margin-left: 8px;">
          <div @click="godetile(3)" style="position: relative;">
            <img style="width: 100%;height:88px" src="../../assets/img/work_pic3.png" />
            <div class="home_zdgzc_div">全域旅游</div>
          </div>
      ...
      <div>
        ...
        <ul class="ui-row" style="margin-top: 20px;">
          ...
          <li @click="godetile(27)" class="ui-col ui-col-33 home_ul_li_style">
            <img class="home_ul_li_img" src="../../assets/img/map5.png" />
            <div class="home_ul_li_div">和顺县</div>
          </li>
      ...
      dd.ready(function() {
        dd.runtime.permission.requestAuthCode({
          // corpId: "dingf1c7cc28f05dbd2335c2f4657eb6378f", // 企业id
           corpId: "ding2ce0705e5be673ea35c2f4657eb6378f", // 企业id
        ...
        .then(res => {
          ...
          if (res.success == "1") {
            for (var i = 0; i < res.data.length; i++) {
              ...
              var id = entity.id;
              this.appLogList.push(httpMethod.returnBaseUrlFun() + entity.log_url);
              // entity.imgUrl = ;
